...
function Search(dom) {
    ...
    $(".card-search").each(function () {
        var texto = $(this).children(".description").children("div").children("div").children(".product_name").children("h4").html().toUpperCase();
...
function SearchMenu(dom) {
    ...
    $(".card-search").each(function () {
        try {
            var texto = $(this).children(".description").children(".caption").children("h6").html().toUpperCase();
            if (texto.indexOf(filter) > -1) {
                $(this).show();
            }
            else {
